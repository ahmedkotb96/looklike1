  ...
  ar: {
    aboutUsMain: {
      hero: {
        ...
        description: "في لوكلايك، نحن أكثر من مجرد وكالة تسويق - نحن شريكك الاستراتيجي في النجاح. استكشف عالمنا من الحلول المبتكرة واكتشف كيف يمكننا تحويل حضور علامتك التجارية الرقمي.",
        button: "اعرف المزيد"
      },
      companies: {
        title: "موثوق به من قبل الشركات في جميع أنحاء العالم"
      },
      sections: {
        story: {
          title: "قصتنا",
          content: "بدأت لوكلايك برؤية لإحداث ثورة في التسويق الرقمي. منذ نشأتنا، نمونا لنصبح وكالة خدمات متكاملة، نقدم حلولاً متطورة تحقق نتائج حقيقية لعملائنا. تتميز رحلتنا بالابتكار والتفاني والسعي المستمر نحو التميز."
        },
        vision: {
          title: "رؤيتنا",
          content: "أن نكون القوة الرائدة في التحول الرقمي، نمكّن الشركات من الازدهار في العصر الرقمي من خلال حلول تسويقية مبتكرة وخدمة استثنائية."
        },
        mission: {
          title: "مهمتنا",
          content: "تحقيق نتائج متميزة من خلال استراتيجيات تسويقية إبداعية قائمة على البيانات تساعد عملائنا على تحقيق أهدافهم التجارية والتميز في مجالاتهم."
        }
      },
      whyChooseUs: {
        seeTeam: {
          ...
          description: [
            "تعرف على العقول المبدعة وراء نجاحنا",
            "كل عضو في الفريق يجلب خبرته وشغفه الفريد"
          ]
        },
        heading: {
          part1: "لماذا",
        ...
        description: "نحن نجمع بين الإبداع والتكنولوجيا والاستراتيجية لتحقيق نتائج استثنائية. نهجنا مبني على:",
        features: [
      ...
      cta: {
        ...
        description: "انضم إلى صفوف الشركات الناجحة التي تعاونت مع لوكلايك لتحقيق أهدافها التسويقية.",
    ...
    companies: {
      title: 'نحظى بثقة الشركات الأكثر ابتكاراً',
      list: ['بابل', 'آي هوم', 'الرحاب للتطوير', 'المسّة', 'فيلاروز', 'بلازا ستريت', 'زودياك', 'ري/ماكس']
    },
    portfolio: {
